  ...
  <html class="no-js lt-ie9 lt-ie8">
    ...
    <html class="no-js lt-ie9">
      ...
      <html class="no-js">
        <!--<![endif]-->
<head>
        <link rel="shortcut icon" href="<?=Yii::app()->
        request->baseUrl?>/favicon.ico" type="image/x-icon">
        <link rel="icon" href="<?=Yii::app()->
        request->baseUrl?>/favicon.ico" type="image/x-icon">
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="<?=Yii::app()->
        request->baseUrl?>/css/bootstrap-theme.css">
        <link rel="stylesheet" href="<?=Yii::app()->
        request->baseUrl?>/css/main.css">
        <link rel="stylesheet" href="<?=Yii::app()->
        request->baseUrl?>/css/1.css">
        <?=$this->
        myVar['css']?>
        <!-- Дата -->
...
<body  class="bs-docs-home">
        ...
        <!-- header -->
        <header id="top" class="navbar navbar-<?=$this->
          myVar['navbar']?>-top bs-docs-nav navbar-inverse" role="banner">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand hidden-xs" href="/">А+5</a>
              ...
              <nav class="collapse navbar-collapse bs-navbar-collapse" id='q1'  role="navigation">
                ...
                <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                  <ul class="nav navbar-nav">
                    ...
                    <li>
                      <a class="hidden-sm" href="/gii">/gii</a>
                    </li>

                    <li>
                      <a class="hidden-sm" href="/office/NewDb">/office/NewDb</a>
                    </li>
